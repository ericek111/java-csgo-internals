...
public final class Offsets {
	...
	public static final String OVERRIDEPOSTPROCESSINGDISABLE_SIGNATURE = "80 3D ?? ?? ?? ?? 00 0F 85 ?? ?? ?? ?? 85 C9";
	public static final String ENTITYLIST_SIGNATURE = "48 8B 05 ?? ?? ?? ?? 48 8B 38 48 8B 07 89 55 B0";
	public static final String GLOWOBJECT_SIGNATURE = "E8 ?? ?? ?? ?? 48 8B 3D ?? ?? ?? ?? BE 01 00 00 00 C7";
	public static final String PLAYERRESOURCES_SIGNATURE = "48 8B 05 ?? ?? ?? ?? 55 48 89 E5 48 85 C0 74 10 48";
	public static final String FORCEJUMP_SIGNATURE = "44 89 e8 c1 e0 1d c1 f8 1f 83 e8 03 45 84 e4 74 08 21 d0";
	public static final String ALT1_SIGNATURE = "44 89 e8 c1 e0 11 c1 f8 1f 83 e8 03 45 84 e4 74 ?? 21 d0";
	public static final String ALT2_SIGNATURE = "44 89 e8 c1 e0 10 c1 f8 1f 83 e8 03 45 84 e4 74 ?? 21 d0";
	public static final String FORCEATTACK_SIGNATURE = "44 89 e8 83 e0 01 f7 d8 83 e8 03 45 84 e4 74 ?? 21 d0";
	public static final String LOCALPLAYER_SIGNATURE = "48 89 e5 74 0e 48 8d 05 ?? ?? ?? ??";
	// public static String GLOBALVARS_SIGNATURE = "4C 8B 25 ?? ?? ?? ?? F3 0F 10 86 C0 3D 00 00 49";
	public static final String GLOBALVARS_SIGNATURE = "48 8B 05 ?? ?? ?? ?? 55 48 89 E5 5D 48 8B 00 F3 0F 10 40 10";
	public static final String GAMERULES_SIGNATURE = "48 8B 05 ?? ?? ?? ?? 48 8B ?? 0F 84";
	public static final String CLIENTCLASSHEAD_SIGNATURE = "44 89 E8 BA 01 00 00 00 44 89 E9 C1 F8 05 D3 E2 48 98 41 09 94 82 ?? ?? ?? ?? 48 8B 05 ?? ?? ?? ?? 8B 53 14 48 8B 00 48 85 C0"; // +26 GAA

	public static final String GAMEDIRECTORY_SIGNATURE = "55 BA 04 01 00 00 48 89 E5 48 81 EC 10 01 00 00 48 8B 3D ?? ?? ?? ?? 48 8D B5 F0 FE FF FF";
	public static final String ENGINEPOINTER1_SIGNATURE = "48 8D 3D ?? ?? ?? ?? 31 F6 48 89 E5 5D E9 8D FF"; // g_SplitScreenMgr
	public static final String ENGINEPOINTER_SIGNATURE = "48 8B 05 ?? ?? ?? ?? 55 48 89 E5 5D 48 8B 38 48 8B 07 48 8B";
	public static final String SPLITSCREENMGR_SIGNATURE = "55 89 FE 48 8D 3D ?? ?? ?? ?? 48 89 E5 5D E9 AD FF FF FF";
	public static final String MDLCACHE_SIGNATURE = "48 8B 05 ?? ?? ?? ?? 55 41 89 F1 44 8B 97 90 01 00 00 31"; // _g_pMDLCache
	public static final String ISTAKINGSCREENSHOT_SIGNATURE = "55 48 85 FF 48 89 E5 C6 05 ?? ?? ?? ?? 01 C6";
	public static final String SETUPCURRENTVIEW_SIGNATURE = "55 4C 8D 0D ?? ?? ?? ?? 48 89 E5 41 56 41 55 45 89 C5 41 54 4C 8D 05";
	
	// Internal
	public static final String CCSMODEMANAGER_INIT_SIGNATURE = " 48 8D 05 ?? ?? ?? ?? 48 89 E5 48 89 05 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5D 48"; //CCSModeManager::Init
