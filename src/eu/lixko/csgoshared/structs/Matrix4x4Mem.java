...
public class Matrix4x4Mem extends MemStruct {
	...
	public final StructField f30 = new StructField(this, Float.BYTES);
	public final StructField f31 = new StructField(this, Float.BYTES);
	public final StructField f32 = new StructField(this, Float.BYTES);
	public final StructField f33 = new StructField(this, Float.BYTES);
	
	public Matrix4x4Mem(MemStruct parent) {
		super(parent);
	}
	...
	public float[][] getMatrix() {
		...
		matrix[3][0] = f20.getFloat();
		matrix[3][1] = f21.getFloat();
		matrix[3][2] = f22.getFloat();
		matrix[3][3] = f23.getFloat();
		return matrix;
	}
}
