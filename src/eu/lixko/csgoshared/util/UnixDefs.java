...
public class UnixDefs {
	public static class sched {
		...
		public static final int CLONE_SIGHAND = 0x00000800; /* set if signal handlers and blocked signals shared */
		public static final int CLONE_PTRACE = 0x00002000; /* set if we want to let tracing continue on the child too */
		...
		public static final int CLONE_THREAD = 0x00010000; /* Same thread group? */
		public static final int CLONE_NEWNS = 0x00020000; /* New mount namespace group */
		public static final int CLONE_SYSVSEM = 0x00040000; /* share system V SEM_UNDO semantics */
		public static final int CLONE_SETTLS = 0x00080000; /* create a new TLS for the child */
		public static final int CLONE_PARENT_SETTID = 0x00100000; /* set the TID in the parent */
		public static final int CLONE_CHILD_CLEARTID = 0x00200000; /* clear the TID in the child */
		public static final int CLONE_DETACHED = 0x00400000; /* Unused, ignored */
		public static final int CLONE_UNTRACED = 0x00800000; /* set if the tracing process can't force CLONE_PTRACE on this clone */
		public static final int CLONE_CHILD_SETTID = 0x01000000; /* set the TID in the child */
		public static final int CLONE_NEWCGROUP = 0x02000000; /* New cgroup namespace */
		public static final int CLONE_NEWUTS = 0x04000000; /* New utsname namespace */
		public static final int CLONE_NEWIPC = 0x08000000; /* New ipc namespace */
		...
		public static final int CLONE_IO = 0x80000000; /* Clone io context */
	}
	...
	public static class mmap {
		...
		public static final int MAP_FOOBAR = 0x0800 /* ETXTBSY */;
	}
